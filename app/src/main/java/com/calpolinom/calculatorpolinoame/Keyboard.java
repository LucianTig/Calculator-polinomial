...
public class Keyboard extends LinearLayout implements View.OnClickListener {
    ...
    private Button button1, button2, button3,button4, button5, button6,button7, button8, button9,button0, buttonplus, buttonminus,buttonla,buttonx,buttonDel;
    ...
    public Keyboard(Context context, AttributeSet attrs, int defStrilyAttr){
        super(context,attrs,defStrilyAttr);
        init(context,attrs);
    }
    ...
    private void init(Context context, AttributeSet attr){
        ...
        keyValues.put(R.id.buttonla,"^");
        keyValues.put(R.id.buttonplus,"+");
        keyValues.put(R.id.buttonminus,"-");
